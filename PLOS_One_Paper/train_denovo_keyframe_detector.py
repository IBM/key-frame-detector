...
if __name__ == "__main__":
    ...
    for k in range(0,num_folds):
        """ For each split extract training, validations sets of data """
        ...
        weights_path = "6LResnet_weights" + str(k) + ".h5"
        model = cnet.create_denovo_network(INPUT_SHAPE, NUM_CLASSES, weights_path=weights_path)
        ...
        hist_ls = model.fit_generator(generate_random_training_samples(train_data, BATCH_SIZE),
                            ...
                            epochs=5, verbose=2,
                            validation_data=generate_random_validation_samples(val_data, BATCH_SIZE),
        ...
        logfile_name = 'train_6LRes_log' + str(k) + ".csv"
        ...
        print('writing file')
        outfilename = 'CAM6LRes_testSetaa' + str(k) + '.csv'
